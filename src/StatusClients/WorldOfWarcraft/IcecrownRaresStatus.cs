...
namespace AtriarchStatus.StatusClients.WorldOfWarcraft
{
    public class IcecrownRaresStatus
    {
        ...
        (
            new RareDescription{Name = "Noth the Plaguebringer",Xcoord = 31.6,Ycoord = 70.5,WowHeadUrl = @"https://www.wowhead.com/npc=174067/noth-the-plaguebringer#drops" },
            new RareDescription{Name = "Patchwerk",Xcoord = 36.5,Ycoord = 67.4,WowHeadUrl = @"https://www.wowhead.com/npc=174066/patchwerk#drops", AltName = "Patchwerk CAVE ENTRANCE", AltXcoord = 34.4, AltYcoord = 68.5},
            new RareDescription{Name = "Blood Queen Lana'thel",Xcoord = 49.7,Ycoord = 32.7,WowHeadUrl = @"https://www.wowhead.com/npc=174065/blood-queen-lanathel#drops" },
            new RareDescription{Name = "Professor Putricide",Xcoord = 57.1,Ycoord = 30.3,WowHeadUrl = @"https://www.wowhead.com/npc=174064/professor-putricide#drops" },
            new RareDescription{Name = "Lady Deathwhisper",Xcoord = 51.1,Ycoord = 78.5,WowHeadUrl = @"https://www.wowhead.com/npc=174063/lady-deathwhisper#drops" },
            new RareDescription{Name = "Skadi the Ruthless",Xcoord = 57.8,Ycoord = 56.1,WowHeadUrl = @"https://www.wowhead.com/npc=174062/skadi-the-ruthless#drops" },
            new RareDescription{Name = "Ingvar the Plunderer",Xcoord = 52.4,Ycoord = 52.6,WowHeadUrl = @"https://www.wowhead.com/npc=174061/ingvar-the-plunderer#drops" },
            new RareDescription{Name = "Prince Keleseth",Xcoord = 54,Ycoord = 44.7,WowHeadUrl = @"https://www.wowhead.com/npc=174060/prince-keleseth#drops" },
            new RareDescription{Name = "The Black Knight",Xcoord = 64.8,Ycoord = 22.1,WowHeadUrl = @"https://www.wowhead.com/npc=174059/the-black-knight#drops" },
            new RareDescription{Name = "Bronjahm",Xcoord = 70.7,Ycoord = 38.4,WowHeadUrl = @"https://www.wowhead.com/npc=174058/bronjahm#drops" },
            new RareDescription{Name = "Scourgelord Tyrannus",Xcoord = 47.2,Ycoord = 66.1,WowHeadUrl = @"https://www.wowhead.com/npc=174057/scourgelord-tyrannus#drops" },
            new RareDescription{Name = "Forgemaster Garfrost",Xcoord = 58.6,Ycoord = 72.5,WowHeadUrl = @"https://www.wowhead.com/npc=174056/forgemaster-garfrost#drops" },
            new RareDescription{Name = "Marwyn",Xcoord = 58.2,Ycoord = 83.4,WowHeadUrl = @"https://www.wowhead.com/npc=174055/marwyn#drops" },
            new RareDescription{Name = "Falric",Xcoord = 50.2,Ycoord = 87.9,WowHeadUrl = @"https://www.wowhead.com/npc=174054/falric#drops" },
            new RareDescription{Name = "The Prophet Tharon'ja",Xcoord = 80.1,Ycoord = 61.2,WowHeadUrl = @"https://www.wowhead.com/npc=174053/the-prophet-tharonja#drops" },
            new RareDescription{Name = "Novos the Summoner",Xcoord = 77.8,Ycoord = 66.1,WowHeadUrl = @"https://www.wowhead.com/npc=174052/novos-the-summoner#drops" },
            new RareDescription{Name = "Trollgore",Xcoord = 58.3,Ycoord = 39.4,WowHeadUrl = @"https://www.wowhead.com/npc=174051/trollgore#drops" },
            new RareDescription{Name = "Krik'thir the Gatewatcher",Xcoord = 67.5,Ycoord = 58,WowHeadUrl = @"https://www.wowhead.com/npc=174050/krikthir-the-gatewatcher#drops" },
            new RareDescription{Name = "Prince Taldaram",Xcoord = 29.6,Ycoord = 62.2,WowHeadUrl = @"https://www.wowhead.com/npc=174049/prince-taldaram#drops" },
            new RareDescription{Name = "Elder Nadox",Xcoord = 44.2,Ycoord = 49.1,WowHeadUrl = @"https://www.wowhead.com/npc=174048/elder-nadox#drops" }
        );
