...
namespace AtriarchStatus.StatusClients.WorldOfWarcraft.Constants
{
    public class IcecrownRareConstants
    {
        public static readonly RareDescription[] Rares = {
            ...
            new RareDescription{Name = "Patchwerk CAVE ENTRANCE", Xcoord = 34.4, Ycoord = 68.5, WowHeadUrl = @"https://www.wowhead.com/npc=174066/patchwerk" },
